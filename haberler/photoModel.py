...
class HaberFotografModel(models.Model):
    ...
    haber = models.ForeignKey(HaberModel, on_delete=models.CASCADE, related_name="haber_foto")
...
@receiver(pre_delete, sender=HaberFotografModel)
